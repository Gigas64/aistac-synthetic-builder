...
/**
 * The {@code CustomerBehaviourBean} Class
 *
 * @author Darryl Oatridge
 * @version 1.00 17-Sep-2017
 */
public class CustomerBehaviourBean extends ObjectBean {
    ...
    public List<Element> getXMLElement() {
        ...
        Element bean = new Element("CustomerBehaviourBean");
        rtnList.add(bean);
        // set the data
    ...
    public void setXMLDOM(Element root) {
        ...
        Element bean = root.getChild("CustomerBehaviourBean");
        // set up the data
