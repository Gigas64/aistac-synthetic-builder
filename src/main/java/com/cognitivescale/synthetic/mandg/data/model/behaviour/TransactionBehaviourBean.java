 ...
 */
/*
 * @(#)TransactionBehaviourBean.java
 *
 * Copyright:       Copyright (c) 2017
 * Organisation:    
 * Schema:          
 */
package com.cognitivescale.synthetic.mandg.data.model.behaviour;
...
/**
 * The {@code TransactionBehaviourBean} Class
 *
 * @author Darryl Oatridge
 * @version 1.00 17-Sep-2017
 */
public class TransactionBehaviourBean extends ObjectBean {
    ...
    public List<Element> getXMLElement() {
        ...
        Element bean = new Element("TransactionBehaviourBean");
        rtnList.add(bean);
        // set the data
    ...
    public void setXMLDOM(Element root) {
        ...
        Element bean = root.getChild("TransactionBehaviourBean");
        // set up the data
