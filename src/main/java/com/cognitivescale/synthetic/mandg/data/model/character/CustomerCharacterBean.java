...
/**
 * The {@code CustomerCharacterBean} Class
 *
 * @author Darryl Oatridge
 * @version 1.00 17-Sep-2017
 */
public class CustomerCharacterBean extends ObjectBean {
    ...
    public List<Element> getXMLElement() {
        ...
        Element bean = new Element("CustomerCharacterBean");
        rtnList.add(bean);
        // set the data
    ...
    public void setXMLDOM(Element root) {
        ...
        Element bean = root.getChild("CustomerCharacterBean");
        // set up the data
