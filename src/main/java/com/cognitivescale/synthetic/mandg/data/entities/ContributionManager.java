...
/**
 * The {@code ContributionManager} Class extends the methods of the parent class.
 *
 * @author Darryl Oatridge
 * @version 1.00 14-Sep-2017
 */
public class ContributionManager extends ObjectSetStore<ContributionBean> {

    /**
     * Constructs a {@code ContributionManager}, passing the manager name which is used to distinguish
     ...
     */
    public ContributionManager(String managerName, ObjectDataOptionsEnum... dataOptions) {
