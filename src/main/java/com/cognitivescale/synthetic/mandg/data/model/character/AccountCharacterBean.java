...
/**
 * The {@code AccountCharacterBean} Class
 *
 * @author Darryl Oatridge
 * @version 1.00 17-Sep-2017
 */
public class AccountCharacterBean extends ObjectBean {
    ...
    public List<Element> getXMLElement() {
        ...
        Element bean = new Element("AccountCharacterBean");
        rtnList.add(bean);
        // set the data
    ...
    public void setXMLDOM(Element root) {
        ...
        Element bean = root.getChild("AccountCharacterBean");
        // set up the data
