...
/**
 * The {@code HoldingsBehaviourBean} Class
 *
 * @author Darryl Oatridge
 * @version 1.00 17-Sep-2017
 */
public class HoldingsBehaviourBean extends ObjectBean {
    ...
    public List<Element> getXMLElement() {
        ...
        Element bean = new Element("HoldingsBehaviourBean");
        rtnList.add(bean);
        // set the data
    ...
    public void setXMLDOM(Element root) {
        ...
        Element bean = root.getChild("HoldingsBehaviourBean");
        // set up the data
