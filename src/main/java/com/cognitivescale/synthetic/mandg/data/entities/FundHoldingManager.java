...
/**
 * The {@code FundHoldingManager} Class extends the methods of the parent class.
 *
 * @author Darryl Oatridge
 * @version 1.00 14-Sep-2017
 */
public class FundHoldingManager extends ObjectSetStore<FundHoldingBean> {

    /**
     * Constructs a {@code FundHoldingManager}, passing the manager name which is used to distinguish
     ...
     */
    public FundHoldingManager(String managerName, ObjectDataOptionsEnum... dataOptions) {
